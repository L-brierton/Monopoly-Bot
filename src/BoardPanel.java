...
class BoardPanel extends JPanel {
	...
	private static final int FRAME_WIDTH = 750;    // must be even //750
	...
	BoardPanel (Players players) {
		...
		try {
			boardImage = ImageIO.read(new File("res/board.jpg"));
//			boardImage = ImageIO.read(this.getClass().getResource("res/board.jpg"));
